          ...
          <div class="content-panel glass-panel chart-panel">
            ...
            <div class="panel-content">
              <div style="margin-bottom:8px;display:flex;gap:8px;align-items:center;">
                ...
                <el-select v-model="accountId" size="small" placeholder="选择账户" style="max-width:200px;" @change="onAccountChange">
                  <el-option
                    v-for="account in availableAccounts"
                    :key="account.account_id"
                    :label="`${account.account_id} (${account.account_type === 2 ? '股票' : '其他'})`"
    ...
    async fetchAvailableAccounts() {
      try {
        ...
        if (accountData && accountData.accounts && accountData.accounts.length > 0) {
          ...
          // 如果没有选中账户，默认选择第一个
          if (!currentAccountId.value && accountData.accounts.length > 0) {
            setCurrentAccountId(accountData.accounts[0].account_id);
          }
