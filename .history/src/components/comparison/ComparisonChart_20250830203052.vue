    ...
    getAssetComparisonOption() {
      ...
      return {
        ...
        series: this.safeSeries([
          { name: '股票A', type: 'line', data: [], smooth: true, itemStyle: { color: '#40e0ff' } },
          { name: '股票B', type: 'line', data: [], smooth: true, itemStyle: { color: '#ff6b6b' } },
          { name: '基准指数', type: 'line', data: [], smooth: true, itemStyle: { color: '#feca57' } },
        ])
      };
    },
